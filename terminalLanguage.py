...
# all operations:
allOperations = [h.lhelp, finance.gettransactions, finance.getbalance, finance.buy, finance.sell, pomodoro.pomodoro, quiz.addquiz,quiz.practicequiz, quiz.removequizquestion, quiz.addquizquestion, quiz.removequiz, humans.nget, humans.addhuman, sql.sql, sleep.frombed, sleep.tobed, humans.getgroup, sleep.sevendays, reading.read, reading.addbook,
